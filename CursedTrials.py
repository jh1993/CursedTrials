...
all_trials.append(Trial("Angry Birds", [FreeFloors(1), ExtraPhoenixFire()]))
...
all_trials.append(Trial("Eye Scream", [FreeFloors(1), NoWalls(), EnemyBuff(lambda: RespawnAs(FloatingEyeIce), exclude_named="Ice Eye")]))
